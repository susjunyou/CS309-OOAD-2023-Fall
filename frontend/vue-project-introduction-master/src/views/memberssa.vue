...
export default {
  ...
  methods: {
    ...
    async loadLocalStorageData() {
      ...
      this.posts=[];
      for (let i = 0; i < localStorage.getItem('coursePostLengthsa'+localStorage.getItem("currentcourse")); i++) {
        this.posts.push({
          id: localStorage.getItem('postidsa' + localStorage.getItem("currentcourse")+i),
          content: localStorage.getItem('postsa' + localStorage.getItem("currentcourse")+i),
          title: localStorage.getItem('posttitlesa' + localStorage.getItem("currentcourse")+i),
          author: localStorage.getItem('postauthorsa' + localStorage.getItem("currentcourse")+i),
        });
      }
      this.materials=[];

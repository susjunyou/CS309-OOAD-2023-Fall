...
public class ProjectController {
    ...
    public Result addProject(String projectTitle, String projectDescription, Date projectDeadline, String projectStatus,
                             Integer maxScore, Double proportion, String releaser, UserType releaserType, Date projectStartDate, Integer maxPeopleInTeam, Integer courseId,  MultipartFile file) {

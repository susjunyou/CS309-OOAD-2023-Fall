        ...
        <div class="assignment-container" style="padding-left: 200px">
          ...
          <el-row :gutter="20">
            <el-col v-for="anouncement in anouncements" :key="anouncement.id" :span="5" >
              <el-card  class="assignment-card" @click.native="showanouncement(anouncement)" style="min-height: 200px">
...
export default {
  ...
  methods: {
    showanouncement(anouncement){
      ...
      this.$router.push({path:'/anouncementsa'})
    },
    async submitForm() {

        ...
        <div class="assignment-container">
          ...
          <el-row :gutter="20">
            <el-col v-for="post in posts" :key="post.id" :span="6" >
              <el-card  class="assignment-card" @click.native="showReplyForm(post)" style="min-height: 230px">
                <h3>{{ post.title }}</h3>
...
export default {
  ...
  methods: {
    ...
    showReplyForm(post){
      ...
      this.$router.push({path:'/postreplysa'})

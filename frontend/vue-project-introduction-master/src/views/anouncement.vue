  ...
  methods: {
    ...
    commitUpdate(){
      ...
      this.$axios.get('/student/updateStudentDetails',{
        params: {
          id:this.edit.e_id,
          email:this.edit.e_email,
          phoneNumber:this.edit.e_phoneNumber,
          selfIntroduction:this.edit.e_selfIntroduction,
          technologyStack:this.edit.technologystack,
          programmingSkill:this.edit.programmingskill,
          intendedTeammate:this.edit.intendedteammate,
        }
      }).then(res => {
        console.log('dd');
        if(res.data.code === "0"){
